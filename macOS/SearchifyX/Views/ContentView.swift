...
struct ContentView: View {
    ...
    @StateObject var wkmodel = WebViewModel()
        ...
        VStack {
                ...
                if showBrowser {
                    VStack {
                        HStack {
                            ...
                            TextField("Enter URL", text: $wkmodel.urlString)
                            Button(action: {
                                wkmodel.loadUrl()
                            }, label: {
                                Text("Go")
                        ...
                        .padding(.trailing)
                        .padding(.leading)
                        NSWebView(webkit: wkmodel.instance)
                    }
                }
                else {
            ...
            HStack {
                ...
                Button(action: {
                    ...
                    wkmodel.urlString = url.absoluteString
                    showBrowser = true
                    wkmodel.loadUrl()
